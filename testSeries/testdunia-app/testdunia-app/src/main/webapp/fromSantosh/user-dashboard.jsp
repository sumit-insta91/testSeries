...
<body class="text-center">
 ...
 <div class="container" style="padding:7%">
   	...
   	<div id="startQuiz">
 		<div class="goForMore">
    		<h3 style="font-size:70px;font-weight: 600;">GO<span style="font-size:70px;font-weight: 400;">FOR</span>MORE</h3>
  					<label class="btn btn-default customRadio" style="border-radius: 20px; margin: 10px;">
    					<a href="/user/user-playquiz" class="startButton">START</a>
  					</label>
   		 </div>
	</div>
